...
if __name__ == '__main__':
    ...
    for i in range(1,31):
        ...
        #print(np.array(y_pred_val_all))
            ...
            # #save model
            with open('1705060_model.pickle', 'wb') as f:
                pickle.dump(model, f)
    ...
    plt.title('Training Loss with Learning Rate '+str(0.001))
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    ...
    plt.title('Validation Loss with Learning Rate '+str(0.001))
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.savefig('validation_loss.png')
    plt.clf()
    plt.plot(validation_accuracy)
    plt.title('Validation Accuracy with Learning Rate '+str(0.001))
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    ...
    plt.title('Validation F1 Score with Learning Rate '+str(0.001))
    plt.xlabel('Epochs')
    plt.ylabel('F1 Score')
